...
**6. Introdução a Web Services - [(Web_Services)](https://github.com/0liveiraVictor/Softex/tree/main/Web_Services)**
...
* **Bloco de Ensino 5 - [Node_JS](https://github.com/0liveiraVictor/Softex/tree/main/Node_JS)**
	...
	* <p align = "Justify">Módulo 2 - Agora você precisa colocar a mão na massa para fazer todas as infraestruturas necessárias para rodar o projeto, depois disso explicar para seu chefe quais são os planos para o fazer rodar. Como você agiria nessa situação?</p>
		...
		- [x] Projeto 03 - [Controle do Fluxo de Requisições](https://github.com/0liveiraVictor/Softex/blob/main/Node_JS/M%C3%B3dulo_02---Projeto_03)
...
* **Bloco de Ensino 6 - [Web_Services](https://github.com/0liveiraVictor/Softex/tree/main/Web_Services)**

	* Módulo 1 - Conceituar o que é a web e seus serviços
	
		- [x] Projeto 01 - [Estrutura do Web Service na Comunicação SOAP](https://github.com/0liveiraVictor/Softex/blob/main/Web_Services/M%C3%B3dulo_01---Projeto_01)
	...
	* Módulo 3 - Conceituar e implementar os modelos REST e RESTful
		...
		- [x] Projeto 02 - [CRUD de um Sistema de Dados de Alunos de Escolas](https://github.com/0liveiraVictor/Softex/blob/main/Web_Services/M%C3%B3dulo_03---Projeto_02)
